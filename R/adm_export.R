...
write.csv(export.final,"output_export_data.csv",row.names=F)
...
upload_cmd=paste(path_system,"pscp -i ",path_key," ",path_client,"raw_data.zip ",export_root,run$client_id,sep="")
shell(upload_cmd)
